import logo from "../images/logo_momentum.png" // add school logo to images folder and import here
...
export const skfURL = 'https://momentumlearn.skills.fund/' // update with Skills Fund url

export const headline = "Learn to Code at Momentum" // update headline as appropriate
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Momentum focuses exclusively on its Coding Bootcamp."
    },
    step3: `You'll be on your way to an exciting career in tech as part of ${schoolName}'s powerful network.`
}

export const netlifyFormName = 'momentumlearning_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "ac84d49d-aefc-4b0c-bfef-e62ac97d5178" // create Hubspot form, get form id after publishing

export const selectAProgram = "select_a_momentumlearning_program" // update school name to match form field on Hubspot, *** change to "program_name" if only one program ***"
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        name: "Immersive Coding",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKMOMSD17",
    ...
    {
        name: "Immersive Coding + Childcare",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKMOMSC17",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 22500,
            loanTerm36: true,
            loanTerm60: true,
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $14,900 for tuition, $4,500 for cost of living, & $3,000 for childcare."
